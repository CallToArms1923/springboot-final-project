<template>
	<div style="height: 100%;">
		<el-main :style='"horizontal" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0 0 0 0px","margin":"0","position":"relative","background":"#f1f2f7","display":"block"} : {"minHeight":"100%","padding":"125px 0 0 215px","margin":"0","position":"inherit","background":"#f7f7f7","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"padding":"0 20px 0 20px","margin":"0","borderColor":"#5daced","alignItems":"center","color":"#eee","display":"flex","justifyContent":"flex-end","top":"0","left":"0","background":"#222A2D","borderWidth":"0 0 0px","width":"calc(100% - 0px)","fontSize":"14px","position":"relative","borderStyle":"solid","zIndex":"1000","height":"50px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"0 30px","margin":"12px 0 0 0","borderColor":"#ddd","borderWidth":"0 0 0px","background":"#fff","display":"block","width":"calc(100% - 0px)","fontSize":"14px","borderStyle":"solid","height":"40px"}' class="bread-crumbs"></bread-crumbs>
