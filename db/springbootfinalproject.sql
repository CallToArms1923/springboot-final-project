...
-- Records of aboutus
-- ----------------------------
INSERT INTO `aboutus` VALUES (1, '2024-03-23 08:04:39', '关于我们', 'ABOUT US', '<p>当你设想门外是寒冷可怕的世界时，你还应该开门出去看看，是否真的如此。如果你有信心，你对前途就不犹豫了。如果你有勇气，你就不怕前途是否有困难或危险了每个人心中都应有两盏灯，一盏是希望的灯，一盏是勇气的灯。有了这两盏灯，我们就不怕海上的黑暗和风涛的险恶了。人的一生很像是在雾中行走。远远望去，只是迷蒙一片，辨不出方向和吉凶。可是，当你鼓起勇气，放下恐惧和怀疑，一步一步向前走去的时候，你就会发现，每走一步，你都能把下一步路看得清楚一点。“往前走，别站在远远的地方观望！”你就可以找到你的方向。</p>', 'upload/1777300635772.jpg', 'upload/1777300643349.JPG', 'upload/1777300655011.jpg');
...
CREATE TABLE `forum`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 84 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '论坛交流' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `luquxinxi`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 37 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '录取信息表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `messages`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 154 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '留言板' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `mianshitongzhi`  (
  ...
  `addtime` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '面试通知表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `mianshitongzhi` VALUES (3, '星巴克门店兼职咖啡师', 'upload/BHHHAIFFJCIHJ-IPc12j8zrd.png', '周末节假日兼职', 'starbucks_zz', '星巴克企业管理（中国）有限公司郑州分公司', '张曼玉', '2026-05-10 10:00:00', '周六', '郑州市郑东新区CBD千玺广场1楼星巴克', 'liyue2026', '李悦', '13937789876', '面试请携带个人简历，有饮品制作经验者可携带相关作品', '2026-04-26 00:00:00', '未回复', '2026-04-26 07:06:22');
...
-- ----------------------------
INSERT INTO `systemintro` VALUES (1, '2024-03-23 08:04:39', '系统简介', 'SYSTEM INTRODUCTION', '<p>在平静的海平面上，每个人都可以成为领航员。但如果只有阳光而没有阴影，只有欢乐而没有痛苦，那就不是完整的人生。就拿最幸福的人来说吧——他的幸福是一团纠结的纱线。痛苦和幸福轮番而至，让我们悲喜交集，甚至死亡都让人生更加可爱。人在生命的严肃时刻，在悲伤与丧亲的阴影下，才最接近真实的自我。在生活和事业的各个方面，才智的功能远不如性格，头脑的功能远不如心性，天分远不如自制力、毅力与教养。我始终认为内心开始过严肃生活的人，他外在的生活会开始变得更为俭朴。在一个奢侈浪费的年代，但愿我能让世人了解：人类真正的需求是多么的稀少。不重蹈覆辙才是真正的醒悟。比别人优秀并无任何高贵之处，真正的高贵在于超越从前的自我。</p>', 'upload/1777300377288.JPG', 'upload/1777300386679.JPG', 'upload/1777300393493.JPG');
...
CREATE TABLE `token`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'token表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of token
-- ----------------------------
INSERT INTO `token` VALUES (1, 1, 'admin', 'users', '管理员', 'o2nivb2rfnqr5dhaqjkgqpk6wycqioyw', '2024-03-23 08:23:15', '2026-05-10 19:05:53');
...
INSERT INTO `token` VALUES (3, 11, '账号1', 'xuesheng', '用户', 'pdf85i5ricz8aapcswv222r59ivk6dyw', '2026-04-17 16:14:09', '2026-05-10 19:16:05');
...
INSERT INTO `token` VALUES (5, 12, 'baozan', 'xuesheng', '用户', 'mltsfkrpw05vj06txte55wbdmb7t7k4s', '2026-04-18 12:13:47', '2026-04-28 02:52:10');
...
INSERT INTO `token` VALUES (20, 40, 'xinhua_bookstore', 'zhaopingongsi', '招聘公司', '2jko0ohfpzoigjjf05mm189el770jm43', '2026-04-27 21:44:11', '2026-05-10 18:07:31');
...
CREATE TABLE `toudixinxi`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 88 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '投递信息' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `toudixinxi` VALUES (73, '2026-04-26 09:06:37', '寒暑假书店整理员', 'upload/BHHHBJDAAHEGD-OJXtLbyIqU.png', '寒暑假专项', 'xinhua_bookstore', '郑州新华书店有限公司', '刘芳', 1, 'xyy', '赵立峰', '17044120066', '本科', '大连理工大学', '', 0, '', '2026-04-02', '是', NULL);
...
INSERT INTO `toudixinxi` VALUES (87, '2026-05-10 09:11:08', '寒暑假书店整理员', 'upload/BHHHBJDAAHEGD-OJXtLbyIqU.png', '寒暑假专项', 'xinhua_bookstore', '郑州新华书店有限公司', '刘芳', 1, '卡力老虎', '樊泽', '16934589310', '大专', '河南职业学院', '', 1, '', '2026-05-10', '待审核', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1777324817193 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `xuesheng` VALUES (1777324817192, '2026-04-27 21:20:17', '卡力老虎', 'e10adc3949ba59abbe56e057f20f883e', '樊泽', '男', 25, '大专', '河南职业学院', 'upload/1777324815283.png', '16934589310');
...
CREATE TABLE `xueshengjianli`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `xuehao`(`xuehao`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1778404192139 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'xueshengjianli' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of xueshengjianli
-- ----------------------------
INSERT INTO `xueshengjianli` VALUES (1778395216609, '2026-05-10 06:40:16', 'xyy', '', '', '在校-月内到岗', '', '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 42 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '招聘公司' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `zhaopinxinxi` VALUES (48, '2026-04-24 15:21:57', '中牟肯德基服务员直聘J19488', 'upload/BHHHABEIABEID-5JNrWKvyIT.png', '长期兼职', '高中', 1, '服务员', '郑州中牟县八房井购物中心', 3500, '肯德基总部直聘服务员欢迎您的加入！\n【福利待遇】\n1、无试用期，无押金\n2、上班员工享受企业内部专享特惠员工餐\n3、工作时间灵活，根据您的空闲时间和餐厅需求进行排班，5-8小时均可\n4、学生兼职可提供实习证明，体验制度成熟的管理运作模式，有广阔的发展空间，大专学历在毕业前可升迁为楼面经理\n5、享有高颜值的工作环境，免费提供时尚高颜值制服，全方位开放的中央空调，冬暖夏凉，员工休息室内冰箱，饮水机，微波炉，一应俱全。', 'kfc', '郑州肯德基有限公司', '王女士', '15366698264', '2026-04-09', '2026-05-10 17:25:54', 20, 8);
INSERT INTO `zhaopinxinxi` VALUES (49, '2026-04-25 02:52:00', '优衣库店员', 'upload/BHHHAIFEIAGDI-hd1z34p1Ik.png', '长期兼职', '大专', 5, '店员', '郑州二七区优衣库（郑州万象城店）1F', 3200, '【全职】\n优衣库（Uniqlo）是迅销集团旗下的世界服装零售业知名品牌，秉承“LifeWear服饰人生”的品牌理念，希望能够用服装的力量让世界各地人们生活更加美好。\n【工作内容】\n1、处理店铺各项基本业务（包括顾客接待、商品整理、收银、试衣间、清扫等）\n2、以优衣库伙伴的角色参与店铺运营\n3、通过自己的努力积极参与店铺团队建设成为店铺的经营者\n岗位福利：五险一金、双休、节假日出勤三薪', 'uniqlo', '迅销（中国）商贸有限公司', '张千越', '13864493057', '2026-04-25', '2026-04-28 05:21:21', 4, 1);
INSERT INTO `zhaopinxinxi` VALUES (50, '2026-04-25 02:53:58', '兼职咖啡师', 'upload/BHHHAIFFJCIHJ-IPc12j8zrd.png', '短期兼职', '本科', 9, '咖啡师', '郑州金水区X•one信万广场（郑州金水店）星巴克', 4000, '', 'starbuck', '星巴克企业管理（中国）有限公司', '李先生', '16985263000', '2026-04-25', '2026-04-26 17:07:37', 5, 0);
INSERT INTO `zhaopinxinxi` VALUES (56, '2026-04-26 07:06:05', '瑞幸咖啡门店长期店员', 'upload/BHHHBJCIHEDEF-D53ttmwlFC.png', '长期兼职', '大专', 4, '饮品制作与门店运营', '郑州市二七区德化街无限城1楼瑞幸咖啡', 4200, '1. 负责瑞幸咖啡饮品标准化制作、点单收银；2. 管理原料库存，确保食材新鲜合规；3. 入职需办理餐饮健康证，有连锁餐饮经验优先', 'luckin_coffee', '瑞幸咖啡（郑州）有限公司', '林晓', '13737788776', '2026-04-26', '2026-04-26 16:41:31', 16, 3);
INSERT INTO `zhaopinxinxi` VALUES (57, '2026-04-26 07:06:05', '外卖配送员（日结）', 'upload/BHHHBJDAGGACE-06LFdvlT76.png', '日结零活', '不限', 8, '订单配送服务', '郑州市管城区银基商贸城配送站', 300, '1. 负责饿了么平台订单配送，3公里内短途单为主；2. 自带电动车，熟悉郑州主城区路线优先；3. 薪资日结，多劳多得，平台提供冲单奖励', 'eleme_delivery', '饿了么郑州城市运营中心', '黄涛', '15937799887', '2026-04-26', '2026-04-26 17:07:49', 33, 6);
INSERT INTO `zhaopinxinxi` VALUES (58, '2026-04-26 07:06:05', '寒暑假书店整理员', 'upload/BHHHBJDAAHEGD-OJXtLbyIqU.png', '寒暑假专项', '大专', 3, '图书整理与读者服务', '郑州市金水区西太康路购书中心', 2500, '1. 负责书店图书上架、分类整理、库存盘点；2. 协助读者找书，维护书店安静阅读环境；3. 仅限在校大学生，工作轻松稳定，提供免费工作午餐', 'xinhua_bookstore', '郑州新华书店有限公司', '刘芳', '18837777665', '2026-04-26', '2026-05-10 17:32:00', 26, 2);
INSERT INTO `zhaopinxinxi` VALUES (59, '2026-04-26 07:06:05', '居家线上远程客服', 'upload/BHHHBJCJGAFCB-uSBJmjTvPu.png', '线上远程兼职', '大专', 4, '客户咨询与售后处理', '线上居家办公', 1500, '1. 负责电商平台客户咨询、订单跟进、售后问题处理；2. 需有安静居家办公环境，普通话标准，打字速度≥40字/分钟；3. 时间灵活，每天在线4小时即可，薪资周结', 'ecom_kefu', '郑州云商电商科技有限公司', '张鑫', '19937766554', '2026-04-26', '2026-05-10 17:26:26', 33, 4);
